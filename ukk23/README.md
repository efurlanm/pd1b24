...
This subrepository contains my notes on the RTE+RRTMGP-PINN research. The initial idea was to replace the [RRTMGP](https://github.com/earth-system-radiation/rte-rrtmgp) lookup table with PINN.
